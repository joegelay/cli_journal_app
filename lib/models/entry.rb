class Entry < ActiveRecord::Base
    ...
    def new_journal_entry(journal_name)
        Entry.create(content: @content, mood: @mood_response, user: @current_user, journal: journal_name)
    end 
